...
GISW.cosmo(omega_m=omega_m, omega_l=omega_l, h0=h0, omega_b=CLASS_COMMON_SETTINGS["omega_b"], ns=CLASS_COMMON_SETTINGS["n_s"], As=CLASS_COMMON_SETTINGS["A_s"], sigma8=sigma_8)
